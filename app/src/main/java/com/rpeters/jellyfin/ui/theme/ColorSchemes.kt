 ...
 * For regular dark mode, we use a primary-tinted background for a more premium "themed" feel.
 */
...
private val JellyfinPurpleDarkColorScheme = darkColorScheme(
    ...
    surfaceVariant = Color(0xFF332F3D),
...
private val MaterialGreenDarkColorScheme = darkColorScheme(
    ...
    surface = Color(0xFF141F14),
    onSurface = Color(0xFFE2E3DE),
    surfaceVariant = Color(0xFF2F3D2F),
...
private val MaterialRedDarkColorScheme = darkColorScheme(
    ...
    onErrorContainer = Color(0xFFFFDAD6),
    // Tinted dark backgrounds
    background = Color(0xFF211717),
    onBackground = Color(0xFFEDE0DD),
    surface = Color(0xFF211717),
...
private val MaterialOrangeDarkColorScheme = darkColorScheme(
    ...
    surface = Color(0xFF211D14),
    onSurface = Color(0xFFEAE1D9),
    surfaceVariant = Color(0xFF3D322F),
